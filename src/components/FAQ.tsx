...
const faqs = [
  ...
  {
    q: "¿Qué incluye la primera evaluación?",
    a: "Diágnostico completo, radiografías digitales de toda el área bucal, fotografías, y escaneo digital",
  },
  {
      ...
      >
        <span
          className={`text-2xl font-semibold transition-colors ${
            open
              ? "text-[#2563EB]"
              : "text-[#0F2044] group-hover:text-[#2563EB]"
          }`}
        >
          {q}
        </span>
