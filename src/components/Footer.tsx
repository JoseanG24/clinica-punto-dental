      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            {/* Logo oficial — fondo blanco propio, se enmarca en el footer oscuro */}
            ...
            <p className="text-white/40 text-sm leading-relaxed mt-5 max-w-[320px]">
              Mas de 20 anos transformando sonrisas en Guatemala. Especialistas en
              Ortodoncia, Implantes y Estetica Dental.
            </p>
        ...
        <div className="border-t border-white/10 pt-7 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/25">
          ...
          <span className="text-center sm:text-right">
            Km 19.5 Carretera a El Salvador, Tecniscan Plaza Minuto, Clinica 6 &middot; Guatemala
          </span>
        </div>
      </div>
    </footer>
